...
export default function ProfilePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axiosInstance.patch("/auth/profile", formDataToSend, {
        headers: {
          ...
          <div className="alert alert-warning mb-6">
            ...
            <div>
              ...
              <div className="text-xs">
                Please verify your email to access all features including ordering.
              </div>
            </div>
            <button 
              ...
              <div className="card-body">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`badge ${user?.emailVerifiedAt ? 'badge-success' : 'badge-warning'}`}>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span>
                      {user && new Date(user.updatedAt || Date.now()).toLocaleDateString()}
                    </span>
                  </div>
